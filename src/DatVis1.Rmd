...
It can be seen that the colors have the same relation to the print master. While it is evidently, that there is always one color withthe smallest delta E regarding the print master, the biggest error almost always appears at the same color spor, too.
