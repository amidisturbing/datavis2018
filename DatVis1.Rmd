...
In this excersise we examin color measurements of prints of Douglas color cards. The intended colors for color card production were compared to thirteen large sheets, sampled from production. Each sample sheet contains 42 color cards.
