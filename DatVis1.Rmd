...
# Results
To examine how many color spots have human visible color differnces in comparison to the master the euclidean distances had to be computed.
...
First of all the L,a,b columns of the Master Matrix were transposed.
The array was replicated to fit the Matrix of the other printers.
That made it easy to use the ΔE Formular to create another Matrix.
